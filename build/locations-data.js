...
const TOWNS = [
  ...
  },
  {
    ...
    intro:
      "Levittown is the classic postwar Long Island suburb: thousands of Cape Cod and ranch-style homes built in the late 1940s and early 1950s. After nearly eight decades, much of the original door hardware is worn out, and many owners are swapping old knobs for reinforced deadbolts and smart locks. Haven Locksmith helps Levittown homeowners with lockouts, rekeying, and lock upgrades, along with nearby Hicksville, East Meadow, Wantagh, and Bethpage.",
    localNote:
  ...
  },
  {
    ...
    intro:
      "Freeport sits on the South Shore, with residential streets, working marinas, and the Nautical Mile of waterfront restaurants along Woodcleft Avenue. Salt air and dampness are hard on exterior locks, latches, and keys, and the restaurants and marine businesses need dependable commercial hardware. Haven Locksmith serves Freeport and neighboring Baldwin, Merrick, Roosevelt, and Bellmore.",
    localNote:
  ...
  },
  {
    ...
    intro:
      "Huntington is a North Shore town with a walkable village of shops and restaurants, historic homes near the harbor, and newer neighborhoods toward Huntington Station and Melville. Older houses often have original hardware that deserves careful work, while village businesses need reliable locks and exit devices. Haven Locksmith serves Huntington and nearby Huntington Station, Melville, Cold Spring Harbor, and Northport.",
    localNote:
  ...
  },
  {
    ...
    intro:
      "Smithtown is a North Shore town of larger-lot colonials and ranches, quiet residential streets, and a Main Street of local businesses. Homes here often have attached garages, side doors, and several entrances, which means more locks to manage. Haven Locksmith serves Smithtown and nearby Kings Park, Nesconset, Commack, and Hauppauge.",
    localNote:
  ...
  },
  {
    ...
    intro:
      "Patchogue is a South Shore village on the Great South Bay, known for a walkable downtown of restaurants, shops, and a historic theater, plus apartments above storefronts and waterfront homes. That mix brings apartment and storefront lockouts, tenant turnover, and business lock work. Haven Locksmith serves Patchogue and nearby East Patchogue, Blue Point, Bellport, and Medford.",
    localNote:
  ...
  },
  {
    ...
    intro:
      "Bay Shore is a South Shore community on the Great South Bay, home to marinas, the ferry terminals for Fire Island, a busy downtown, and residential neighborhoods. Boaters and ferry passengers get locked out of cars, and year-round residents call for rekeying and lock upgrades. Haven Locksmith serves Bay Shore and nearby Brightwaters, West Islip, Islip, and Brentwood.",
    localNote:
  ...
  },
  {
    ...
    intro:
      "Islip is a South Shore community on the Great South Bay with older bay-side homes, quiet residential blocks, and businesses along Montauk Highway. Lockouts, rekeying after a move, and lock upgrades are the usual calls, along with car key and fob work for commuters. Haven Locksmith serves Islip and nearby Bay Shore, East Islip, Islip Terrace, and Great River.",
    localNote:
