...
Marketing website for Guardian Locksmith, a locksmith business serving Long Island, NY. Static HTML/CSS/JS with no framework. The SEO pages (services, towns, and every service in every town) are generated by a small Node script: `npm run build`.
...
- Phone number `(516) 555-0142`, email `info@guardianlocksmith.com`, and the footer license number (`License #placeholder-0000`).
